...
export default function Header() {
  ...
  return (
    <>
      ...
      {isModalOpen && (
        <CitySelectModal onClose={() => setIsModalOpen(false)} onCitySelect={handleCitySelect} />
      )}

      <header
        className={`fixed top-0 left-0 w-full z-50 flex flex-col lg:flex-row items-center justify-between px-4 lg:px-12 border-b border-white ${
      ...
      >
        ...
        {/* Desktop Nav */}
        <nav className="hidden lg:flex items-center gap-8 [font-family:'Barlow_Condensed',Helvetica] text-2xl ">
          <Link href="/" className="text-white font-semibold hover:border-b-2 hover:border-white pb-1">HOME</Link>
          <Link href="/pages/values" className="text-white font-semibold hover:border-b-2 hover:border-white pb-1">VALUES</Link>
          <Link href="/pages/build" className="text-white font-semibold hover:border-b-2 hover:border-white pb-1">BUILD YOUR OWN</Link>
          <Link href="/pages/menu" className="text-white font-semibold hover:border-b-2 hover:border-white pb-1">MENU</Link>
        </nav>
        ...
        <div className="flex items-center gap-4 mt-4 lg:mt-0 w-full lg:w-[50%] max-sm:hidden max-lg:hidden">
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[.6rem]">{selectedCity || "Select your address"}</span>
            </div>
          </div>
